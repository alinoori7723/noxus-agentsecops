...
export const conditionalPassSummary: ReadinessSummary = {
  ...
  before_score: 0,
  before_score_label: "Baseline readiness score",
  baseline_readiness_score_label: "Baseline readiness score",
  readiness_gate_score_label: "Readiness gate score",
  score_direction_explanation:
    "Readiness score measures deployability. Higher is safer. Risk is represented separately by failed probes, unresolved findings, and human-review requirements.",
  qualitative_risk_level: "Medium",
  after_score: 90,
  ...
  blue: {
    ...
    patches: [
      {
        ...
        primary_source_finding_id: "probe_indirect_prompt_injection:indirect_prompt_injection_simulated",
        ...
        related_finding_groups: { same_category_related: [], leakage_from_same_probe: [], generic_policy_related: [] },
    ...
    remediation: {
      ...
      probe_finding_mapping: {
        ...
        note:
          "One probe may emit multiple findings. Remediation progress is counted by finding instances; human review is grouped by unresolved finding categories.",
        baseline_probe_count: 6,
        baseline_failed_probe_count: 5,
        baseline_finding_count: 6,
        baseline_finding_instance_count: 6,
        retest_probe_count: 6,
        retest_failed_probe_count: 1,
        retest_finding_count: 1,
        retest_finding_instance_count: 1,
        resolved_finding_count: 5,
        resolved_finding_instance_count: 5,
        unresolved_finding_count: 1,
        unresolved_finding_instance_count: 1,
        unresolved_finding_types: ["must_not_appear_violation"],
        baseline_label: "5 failed probes -> 6 finding instances",
        retest_label: "1 failed probes -> 1 unresolved finding instances",
        resolved_label: "5 finding instances resolved",
      },
      gate_blocked_explanation: "",
      gate_blocking_reason: "",
      gate_blocking_finding_types: ["must_not_appear_violation"],
      unresolved_finding_instances: [],
      unresolved_not_human_reviewed: [],
      human_review_derived_finding_instance_count: 1,
      human_review_derived_finding_type_count: 1,
    },
    resolved_finding_types: ["indirect_prompt_injection_simulated", "pii_leakage"],
    unresolved_findings: [proprietaryFindingRow],
    blocking_explanation:
  ...
  blue: {
    ...
    remediation: {
      ...
      probe_finding_mapping: {
        ...
        baseline_finding_count: 6,
        baseline_finding_instance_count: 6,
        retest_probe_count: 0,
        retest_failed_probe_count: 0,
        retest_finding_count: 0,
        retest_finding_instance_count: 0,
        resolved_finding_count: 0,
        resolved_finding_instance_count: 0,
        unresolved_finding_count: 6,
        unresolved_finding_instance_count: 0,
        unresolved_finding_types: ["must_not_appear_violation"],
        baseline_label: "5 failed probes -> 6 finding instances",
        retest_label: "0 failed probes -> 0 unresolved finding instances",
        resolved_label: "0 finding instances resolved",
      },
      gate_blocked_explanation: "",
      gate_blocking_reason: "Reason: must_not_appear_violation unresolved",
      gate_blocking_finding_types: ["must_not_appear_violation"],
      unresolved_finding_instances: [],
      unresolved_not_human_reviewed: [],
      human_review_derived_finding_instance_count: 6,
      human_review_derived_finding_type_count: 1,
    },
    resolved_finding_types: [],
    unresolved_findings: [proprietaryFindingRow],
  ...
  blue: {
    ...
    patches: [
      {
        ...
        primary_source_finding_id: "probe_pii_leakage:pii_leakage",
    ...
    rejected_proposals: [
      {
        ...
        primary_source_finding_id: null,
    ...
    remediation: {
      ...
      probe_finding_mapping: {
        ...
        baseline_finding_count: 6,
        baseline_finding_instance_count: 6,
        retest_probe_count: 5,
        retest_failed_probe_count: 5,
        retest_finding_count: 9,
        retest_finding_instance_count: 9,
        resolved_finding_count: 0,
        resolved_finding_instance_count: 0,
        unresolved_finding_count: 9,
        unresolved_finding_instance_count: 9,
        unresolved_finding_types: ["must_not_appear_violation", "pii_leakage"],
        baseline_label: "5 failed probes -> 6 finding instances",
        retest_label: "5 failed probes -> 9 unresolved finding instances",
        resolved_label: "0 finding instances resolved",
      },
      gate_blocked_explanation:
        "Readiness improved, but deployment remains blocked because unresolved high-risk findings remain.",
      gate_blocking_reason:
        "Reason: must_not_appear_violation, pii_leakage unresolved",
      gate_blocking_finding_types: ["must_not_appear_violation", "pii_leakage"],
      unresolved_finding_instances: [],
      unresolved_not_human_reviewed: [],
      human_review_derived_finding_instance_count: 9,
      human_review_derived_finding_type_count: 2,
    },
    resolved_finding_types: [],
    unresolved_findings: [proprietaryFindingRow],
    blocking_explanation:
