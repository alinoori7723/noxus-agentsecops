...
export const conditionalPassSummary: ReadinessSummary = {
  ...
  readiness_score_explanation:
    "Readiness score measures deployability. Higher is safer. Risk is shown separately through failed probes, unresolved findings, and human-review categories.",
  risk_level: "Medium",
  ...
  blue: {
    ...
    remediation: {
      ...
      probe_finding_mapping: {
        ...
        resolved_finding_count: 5,
        unresolved_finding_count: 1,
        baseline_label: "5 failed probes -> 6 findings",
        retest_label: "1 failed probes -> 1 findings",
        resolved_label: "5 findings resolved",
      },
      gate_blocked_explanation: "",
  ...
  blue: {
    ...
    remediation: {
      ...
      probe_finding_mapping: {
        ...
        unresolved_finding_count: 6,
        baseline_label: "5 failed probes -> 6 findings",
        retest_label: "0 failed probes -> 0 findings",
        resolved_label: "0 findings resolved",
      },
      gate_blocked_explanation: "",
  ...
  blue: {
    ...
    remediation: {
      ...
      probe_finding_mapping: {
        ...
        unresolved_finding_count: 9,
        baseline_label: "5 failed probes -> 6 findings",
        retest_label: "5 failed probes -> 9 findings",
        resolved_label: "0 findings resolved",
      },
      gate_blocked_explanation:
        "Readiness improved, but deployment remains blocked because unsupported high-risk findings remain.",
      gate_blocking_reason:
