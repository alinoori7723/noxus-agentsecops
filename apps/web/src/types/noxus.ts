...
export type ProviderType = "local_openai_compatible" | "openai_compatible" | "gemini_native";
...
export interface RunAssessmentRequest extends ProviderSelection {
    mode: Mode;
    system_prompt: string;
    security_policy_yaml: string;
    business_context: string;
...
export type PatchStatus = "applied_and_resolved" | "applied_but_primary_unresolved" | "applied_but_related_risk_unresolved" | "applied_requires_human_review" | "rejected_unlinked";
...
export type StageStatus = "used" | "not_used" | "failed" | "skipped" | "human_review_required";
