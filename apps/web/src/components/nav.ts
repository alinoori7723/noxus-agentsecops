import { LayoutDashboard, FileCog, PlayCircle, BarChart3, FileSearch, ShieldAlert, Plug, ShieldCheck, type LucideIcon, } from "lucide-react";
export type SectionId = "overview" | "target" | "assessment" | "results" | "evidence" | "risks" | "provider" | "proof";
