      ...
      <div className="space-y-1.5">
        {failure && (<>
            ...
            <div className="flex flex-wrap gap-x-4 gap-y-0.5 text-[12px]">
              ...
              {failure.provider_type && (<span>
                  Provider: <span className="font-mono">{failure.provider_type}</span>
                </span>)}
              {failure.timeout_seconds != null && (<span>Timeout: {failure.timeout_seconds}s</span>)}
        ...
        {fallback && fallback.used && (<p className="flex items-center gap-1.5 text-[12px] font-medium">
            <RefreshCw size={13}/>
