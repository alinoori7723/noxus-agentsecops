...
- [ ] Full suite green (release verification: **430 Python tests** with dev extras installed).
- [ ] Frontend tests green (**51 frontend tests**).

```bash
python3 -m venv .venv && .venv/bin/pip install -e ".[dev]"
.venv/bin/pytest -q          # release-verified at 430 Python tests (httpx from dev extras)
