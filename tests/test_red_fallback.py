...
from noxus.schemas import PatchOp, ReadinessState
...
def test_red_team_prompt_instructs_model_not_to_follow_target_content():
    ...
    assert "Return only the required JSON object matching the RedTeamProbeBatch schema." in prompt
...
def test_red_team_failure_records_fallback_used_deterministic_baseline():
    ...
    assert meta.red_team_failure_excerpt
