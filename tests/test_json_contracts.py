...
def test_json_contract_accepts_valid_probe_json():
    ...
    obj = load_validated_object(provider, "m", m2_data.VALID_PROBE_BATCH, ProbeBatch, "ProbeBatch")
...
def test_json_contract_rejects_invalid_json_after_one_repair():
    ...
    with pytest.raises(SchemaContractError):
        load_validated_object(provider, "m", m2_data.INVALID_JSON, ProbeBatch, "ProbeBatch")
