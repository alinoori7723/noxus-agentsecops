...
class SemanticJudgment(BaseModel):
    ...
    def _must_be_semantic(cls, value: DetectionMode) -> DetectionMode:
        if value is not DetectionMode.semantic_llm:
            raise ValueError("SemanticJudgment.detection_mode must be 'semantic_llm'.")
        return value
...
class PatchOperation(BaseModel):
    ...
    primary_source_finding_type: str | None = None
    primary_source_probe_id: str | None = None
...
class ReportMetadata(BaseModel):
    ...
    schema_failure_excerpt: str | None = None

    red_team_status: str | None = None
    fallback_used: str | None = None
    fallback_reason: str | None = None
    continued_after_red_failure: bool = False
    red_team_failure_excerpt: str | None = None

    semantic_judge_status: str | None = None
    semantic_judge_failure_excerpt: str | None = None
    ...
    timeout_failed_role: str | None = None
    timeout_failed_stage: str | None = None
    timeout_provider_type: str | None = None
    timeout_model: str | None = None
    ...
    tuning_fallback_original_model: str | None = None
