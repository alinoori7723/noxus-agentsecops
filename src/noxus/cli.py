...
from .llm_provider import LiteLLMProvider, LLMProvider, ProviderError
    ...
    try:
        ...
        if args.mode == "deterministic":
            ...
            report = run_readiness_assessment(
                ...
                mode="agent_assisted",
                provider=provider,
                red_model=_models_from_env()["red_model"],
                judge_model=_models_from_env()["judge_model"],
                tuning_model=_models_from_env()["tuning_model"],
            )
